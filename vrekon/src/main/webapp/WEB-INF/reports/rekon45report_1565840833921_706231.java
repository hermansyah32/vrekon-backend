/*
 * Generated by JasperReports - 8/15/19 10:47 AM
 */

/**
 *
 */
public class rekon45report_1565840833921_706231 extends JREvaluator
{
    ...
    public Object evaluate(int id) throws Throwable
    {
        ...
        switch (id)
        {
            ...
            case 8 : 
            {
                value = (java.lang.Integer)(((java.lang.Integer)parameter_Page.getValue()));//$JR_EXPR_ID=8$
                break;
            }
            case 9 : 
            {
                value = (java.lang.String)((((java.lang.String)parameter_Date.getValue())==null || ((java.lang.String)parameter_Date.getValue()).equals("")) ? new SimpleDateFormat("dd-MMM-yyyy").format(new Date()) : ((java.lang.String)parameter_Date.getValue()));//$JR_EXPR_ID=9$
                break;
            }
            case 10 : 
            {
                value = (java.lang.String)(new SimpleDateFormat("hh:mm:ss").format(new Date()));//$JR_EXPR_ID=10$
                break;
            }
           default :
           {
